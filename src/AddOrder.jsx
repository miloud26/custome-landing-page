...
`,
  ...
  const handleSubmitOrder = async (e) => {
    ...
    try {
      ...
      data.append("product", "ليكات و سروال");
      data.append("name", name);
      data.append("phone", `${phone}`);
      data.append("wilaya", wilaya);
      data.append("adress", adress);
      data.append("size", modelSize);
      data.append("color", modelColr);
      data.append("price", price);
      data.append("remark", remerk);

      await fetch(
        "https://script.google.com/macros/s/AKfycbxZBsayPKlrPGGfXod1bYyirIjgX1sSTz_TPFp63NBAgfHk9Pq9ubL-OV1EBoW1av_v/exec",
        {
          method: "POST",
          body: data,
        }
      ...
      >
          ...
          <FormControl fullWidth>
            ...
            >
              {communeInfo.slice(2).map((item, index) => {
                return (
                  <MenuItem sx={{ direction: "ltr" }} key={index} value={item}>
                    {item}
                  </MenuItem>
                );
              })}
        ...
        >
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              value={modelColr}
              label="Commune"
              onChange={(e) => setModelColr(e.target.value)}
            >
              {["Noir", "Bleu Nuit", "Marron"].map((item, index) => {
                return (
                  <MenuItem sx={{ direction: "ltr" }} key={index} value={item}>
                    {item}
                  </MenuItem>
        ...
        >
          ...
          <TextField
            ...
            placeholder="ملاحظة"
            label="ملاحظة"
            onChange={(e) => setRemerk(e.target.value)}
          />
        </Box>
